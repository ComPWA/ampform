...
def describe_unevaluated():
    def it_shares_class_variables_between_instances():
        @unevaluated
    ...
    def it_preserves_attributes_marked_as_non_sympy():
    ...
    def it_uses_default_arguments_unless_overridden():
        @unevaluated
        class MyExpr(sp.Expr):
            x: Any
            m: int = 2
    ...
    def it_keeps_default_arguments_separate_from_class_variables():
        @unevaluated
    ...
    def it_uses_qualified_class_names_in_hashable_content():
        class CannotBeSympified: ...
    ...
    def it_warns_about_misspelled_latex_attributes():
        with pytest.warns(
            UserWarning,
    ...
    def it_leaves_expressions_unevaluated_when_doit_is_disabled():
        @unevaluated(implement_doit=False)
    ...
    def it_accepts_numeric_and_expression_arguments():
        @unevaluated
    ...
    def it_preserves_nested_expressions_in_a_pickle_roundtrip():
        x = sp.Symbol("x")
    ...
    def it_preserves_non_sympy_attributes_during_substitution():
        class Protocol: ...
    ...
    def it_replaces_symbols_and_non_sympy_attributes():
        class Protocol: ...
